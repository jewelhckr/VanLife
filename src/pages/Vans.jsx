  ...
  <div className="container-fluid animate__animated animate__fadeIn">
   <Link to={"/"} className='text-decoration-none navbar-brand fw-bold '>#VANLIFE</Link> 
    ...
    <ul className='col-md-3 gap-3  d-flex list-unstyled' style={{cursor:"pointer"}}>
      ...
      <Link to={"/vans"} className='text-decoration-none text-black text-decoration-underline'>Vans</Link>
  </ul>
  ...
  <div className="row gap-3">
    {vans.map(van => (
      <div key={van.id} className="col-md-4">
        ...
        <button className='btn btn transparent text-white  fw-bold' style={{ backgroundColor: van.color || '#e17654' }}>{van.type}</button>
        </Link>
