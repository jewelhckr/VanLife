  ...
  <div className="row align-items-center">
    ...
    <div className="col">
      <div className="d-flex justify-content-between align-items-center">
        <div>
        <button className='btn btn transparent text-white  fw-bold' style={{ backgroundColor: host.color || '#e17654' }}>{host.type}</button><br />
    ...
    <span className='col-3 text-decoration-underline fw-bold'>Details</span>
        <span  className='col-3'>Pricing </span>
        <span  className='col-2'>Photos</span>
    </div>
