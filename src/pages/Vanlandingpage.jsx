  ...
  return (
    ...
    <Navbar/>
      <div className="myComponent p-5">
        ...
        <p className='text-center text-white'>Add adventure to your life by joining the #vanlife movement. <br /> Rent the perfect van to make your perfect road trip.</p>
        <p></p>
        <Link to={'/vans'}>
