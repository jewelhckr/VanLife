  ...
  return (
    <>
        ...
        <div className="container d-flex gap-2">
          ...
          <div className="col-md-3 col-lg-1 ">
            <Link to={'/income'}><button className="btn btn-transparent fw-bold text-decoration-underline">Income</button></Link>
          </div>
          <div className="col-md-3 col-lg-1 ">
            <Link to={'/host/vans'}>
       ...
       <span className='text-secondary'>Last</span> <span className='text-decoration-underline text-secondary fw-bold '> 30 days</span>
       <p className='display-3 mt-4 fw-bold'>$2,260</p>
       <br />
       <br />
       <img src="src/assets/vanchart.png" alt="" className='container-fluid col-lg-7'/>
       ...
       <div style={{ backgroundColor: "#fef6ed", padding: "10px" }}>
        ...
        >
          ...
          <span>Last <span className='text-decoration-underline text-secondary fw-bold'> 30 days</span></span> 
